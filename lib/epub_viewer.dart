...
class EpubViewer {
  ...
  static void open(String bookPath, {required EpubLocator lastLocation}) async {
    Map<String, dynamic> agrs = {
      "bookPath": bookPath,
      'lastLocation':
  ...
  /// Last location is only available for android.
  static Future openAsset(String bookPath, {required EpubLocator lastLocation}) async {
